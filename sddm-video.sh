...
Numlock=on
$DISPLAY_SERVER_LINE
# InputMethod= vide : empêche SDDM de démarrer IBus dans la session de login.
# Sans cela, IBus génère une alerte Wayland au premier démarrage de session
# car QT_IM_MODULE et GTK_IM_MODULE sont hérités de l'environnement SDDM.
InputMethod=
