 ...
 * Licence : GPL-3.0
 *
 * Utilise UNIQUEMENT SddmComponents 2.0 pour les widgets de login
 * (TextBox, PasswordBox, ComboBox, LayoutBox, Button, TextConstants)
 * → zéro mélange avec QtQuick.Controls
 ***************************************************************************/
